...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        for (String arg: args)
        {
            ...
            if (arg.equals("ChewingGum"))
            {
                System.out.println("Введите вкус жвачки");
                Scanner in = new Scanner(System.in);
                String flavour = in.nextLine();
                breakfast[itemsSoFar] = new ChewingGum(flavour);
            }
    ...
    static void printFoods(Food[] breakfast)
    {
        ...
        System.out.println("ChewingGum - " + t);
